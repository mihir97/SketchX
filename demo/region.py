...
def get_regions(img):
    ...
    kernel = np.ones((3,9), np.uint8)       # vary the two parameters for horizontal/vertical grouping
    img = cv2.dilate(img, kernel, iterations=5) #iterations is another parameter to vary
